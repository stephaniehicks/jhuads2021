...
and you can find many versions installed on your computer: 
...
# Learn Python via R resources 

<blockquote class="twitter-tweet"><p lang="en" dir="ltr">What&#39;s the best resource online for an <a href="https://twitter.com/hashtag/RStats?src=hash&amp;ref_src=twsrc%5Etfw">#RStats</a> programmer to learn <a href="https://twitter.com/hashtag/Python?src=hash&amp;ref_src=twsrc%5Etfw">#Python</a>? <a href="https://twitter.com/hashtag/DataScience?src=hash&amp;ref_src=twsrc%5Etfw">#DataScience</a> <a href="https://twitter.com/hashtag/AdventOfCode?src=hash&amp;ref_src=twsrc%5Etfw">#AdventOfCode</a></p>&mdash; Michael Barrowman (@MyKo101AB) <a href="https://twitter.com/MyKo101AB/status/1467175110977232897?ref_src=twsrc%5Etfw">December 4, 2021</a></blockquote> <script async src="https://platform.twitter.com/widgets.js" charset="utf-8"></script>
...
You can use the `import()` function to import any Python module and call it from R. For example, this code imports the Python `os` module (operating system) (https://docs.python.org/3/library/os.html) in python and calls the `listdir()` function (https://docs.python.org/3/library/os.html#os.listdir): 
